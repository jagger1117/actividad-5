...
public class VentanaPrincipal extends JFrame implements ActionListener {
    ...
    private void inicio() {
        ...
        nota1.setBounds(20, 20, 150, 23);
        campoNota1 = new JTextField();
        campoNota1.setBounds(125, 20, 150, 23);

        nota2 = new JLabel();
        nota2.setText("Nota 2:");
        nota2.setBounds(20, 50, 150, 23);
        campoNota2 = new JTextField();
        campoNota2.setBounds(125, 50, 150, 23);

        nota3 = new JLabel();
        nota3.setText("Nota 3:");
        nota3.setBounds(20, 80, 150, 23);
        campoNota3 = new JTextField();
        campoNota3.setBounds(125, 80, 150, 23);

        nota4 = new JLabel();
        nota4.setText("Nota 4:");
        nota4.setBounds(20, 110, 150, 23);
        campoNota4 = new JTextField();
        campoNota4.setBounds(125, 110, 150, 23);

        nota5 = new JLabel();
        nota5.setText("Nota 5:");
        nota5.setBounds(20, 140, 150, 23);
        campoNota5 = new JTextField();
        campoNota5.setBounds(125, 140, 150, 23);

        calcular = new JButton();
        calcular.setText("Calcular");
        calcular.setBounds(20, 180, 120, 23);

        calcular.addActionListener(this);

        limpiar = new JButton();
        limpiar.setText("Limpiar");
        limpiar.setBounds(150, 180, 100, 23);

        limpiar.addActionListener(this);

        promedio = new JLabel();
        promedio.setText("Promedio = ");
        promedio.setBounds(20, 220, 150, 23);

        desviación = new JLabel();
        desviación.setText("Desviación = ");
        desviación.setBounds(20, 250, 200, 23);

        mayor = new JLabel();
        mayor.setText("Nota mayor = ");
        mayor.setBounds(20, 280, 120, 23);

        menor = new JLabel();
        menor.setText("Nota menor = ");
        menor.setBounds(20, 310, 120, 23);
